...
const FeatureScreen = ({ features, selected, bottomSheet, onFeatureChange }) => {

    const [search, setSearch] = useState('');

    const getFilterList = () => {
        const filter_list = features.filter(feature => feature.name.toLowerCase().includes(search.toLowerCase()));
